          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="start" className="w-40">
              <DropdownMenuItem asChild>
                <Link to="/properties?type=villa" className="w-full">Villas</Link>
              </DropdownMenuItem>
              <DropdownMenuItem asChild>
            ...
            <div className="container py-4 flex flex-col gap-3">
              ...
              <div className="py-2">
                ...
                <div className="flex flex-col gap-2 pl-4">
                  <Link to="/properties?type=villa" className="py-1 text-sm font-medium" onClick={() => setIsOpen(false)}>Villas</Link>
